...
|---|---|---|---|
| Test app bên ngoài: Nhập chi tiêu bằng tin nhắn Telegram đơn giản | ![IMG_1013](IMG_1013.jpg) | Happy | Việc chỉ cần gửi tin nhắn text (không form) rất thuận tiện, giảm friction lớn |
| AI tự động phân loại chi tiêu mà không cần xác nhận từng field | ![IMG_0354](IMG_0354.png) | Happy | Người dùng sẽ tiết kiệm thời gian nhập liệu, tăng tỷ lệ ghi chép chi tiêu |
| Xác nhận dữ liệu qua Telegram (không cần mở web) | ![IMG_0355](IMG_0355.png) | Happy | Flow trên mobile/chat rất natural, không cần switch app ||
